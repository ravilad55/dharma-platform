...
namespace Dharma.Infrastructure.Persistence.Migrations
{
    ...
    {
        private static readonly string[] CartItemProductColumns = ["CartId", "ProductId"];
        private static readonly string[] CartShopStatusColumns = ["ShopId", "Status"];
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_carts_pooja_shops_ShopId",
                        column: x => x.ShopId,
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "cart_items",
                columns: CartItemProductColumns,
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_carts_ShopId_Status",
                table: "carts",
                columns: CartShopStatusColumns);
        }
